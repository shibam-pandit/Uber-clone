...
import CpatainNavbar from '../captain-components/Captain_Navbar';
...
const Contact = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-50">
            {requestFrom==="home" && <Navbar currentPath="/contact" />}
            {requestFrom==="captain-home" && <CpatainNavbar currentPath="/contact" />}
                ...
                <div className="grid md:grid-cols-2 gap-10">
                    ...
                    <div className="bg-white p-8 rounded-lg shadow-md">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button
                                type="submit"
                                className="w-full bg-black hover:bg-gray-800 text-white py-3 px-6 rounded-md transition duration-300"
                            >
                                Send Message
                            </button>
                        </form>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">123 Transport Street, San Francisco, CA 94158, USA</p>
                                </div>
                            </div>
                            <div className="flex items-start space-x-4">
                                <div className="bg-gray-100 p-3 rounded-full">
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">support@uberclone.com</p>
                                </div>
                            </div>
                            <div className="flex items-start space-x-4">
                                <div className="bg-gray-100 p-3 rounded-full">
